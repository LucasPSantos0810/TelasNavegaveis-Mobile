function validarCamposPT(){
	...
	var recarregar = document.getElementById('cadastro').innerHTML = '<a href="cadastroPT.html" id="cadastrar"><div class="link0"><center>Cadastrar</div></a>';
